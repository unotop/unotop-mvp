...
const TOUR_STEPS: OnboardingStep[] = [
  {
    ...
    description:
      "Zadajte, koľko vám mesačne príde a odíde. To, čo zostane ako voľné peniaze, vieme investovať. Nič nepokazíte – čísla môžete kedykoľvek upraviť.",
    targetId: "sec1",
  ...
  },
  {
    ...
    description:
      "Jednorazovo = koľko máte dnes. Mesačný vklad = koľko chcete pravidelne posielať. Horizont = na koľko rokov. Cieľ je voliteľný – ak neviete, preskočte.",
    targetId: "sec2",
    position: "right", // Ľavý panel → tooltip vpravo
  },
  {
    ...
    description:
      "Tri jednoduché voľby: Konzervatívny (pokojnejší), Vyvážený, Rastový (vyšší výnos, väčšie výkyvy). V BASIC režime stačí vybrať štýl – detaily riešime na stretnutí.",
    targetId: "sec3",
    position: "right", // Ľavý panel → tooltip vpravo
  },
  {
    ...
    description:
      "Vpravo uvidíte očakávaný majetok, modelový ročný výnos a riziko (0–10). Krivka je odhad – mení sa podľa vašich vstupov. Odporúčame mať rezervu 3–6 mes. výdavkov.",
  ...
  },
  {
    ...
    description:
      "Kliknite Odoslať projekciu. Ozveme sa a nastavíme konkrétne riešenia (ETF, zlato, dlhopisy…) aj plán, ako dosiahnuť váš cieľ. Môžete zaškrtnúť, že chcete pomôcť s rezervou alebo zvýšiť príjem/spoluprácu.",
